    ...
    <form action={action} className="app-card grid gap-4">
      <div>
        ...
        <p className="mt-1 text-sm font-semibold text-zinc-600">
          Vagtcentralen får besked med det samme. Tilgængeligheden gælder frem til næste vagtskifte.
        </p>
      </div>
...
export function AvailabilityActiveForm({
  ...
  return (
    ...
    >
      ...
      <div>
        <p className="text-sm font-black uppercase tracking-wide text-emerald-700">● Aktiv</p>
        <h2 className="mt-1 text-2xl font-black text-emerald-950">Du er til rådighed</h2>
